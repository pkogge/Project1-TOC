...
def construct_config_json(
    project_value: ProjectSelection, sub_probs: List[SubProblemSelection]
):
    project = {"Selection": {"name": project_value.name, "value": project_value.value}}
    temp = []
...
def brief_about_project():
    ...
    print(
        "Hello Guys, This is project 1 script for students, This will be asked for the first time,"
    )
    print(
        "once you answer all the questions the program will try to build a configuration file,"
    )
    print("which consists of infroamtion about your project selection.")
    print(
        "based on the configuration setting we will be performing the grading for this project"
    )
    ...
    print(" ")
    print(
        ">>> Here are list of project problems, please select one option among them, NOTE: Input numbers only "
    )
    print(" ")
    project_dict = {}
    ...
    print(" ")
    print(
        "Please verify it once, if its wrong rerun the program, but terminating it here!!"
    )
    print(
        "**********************************************************************************************"
    )
    print(" ")
    print(
        "A lot of teams have selected mutliple ways to solve, if you are team is working on single solution there"
    )
    print(
        "the entry should be single and followed by alternative option of entering big number which terminates the "
    )
    print("selection. NOTE: Please follow instructions as stated below")
    print(" ")
    print(
        ">>> Select the methods how want to solve this problem, if you want to terminate this enter any number larger"
    )
    ...
    for index, sub_problem in enumerate(SubProblemSelection):
        print(
            f" Are you trying to solve the {project_dict[project_value].value} using '{sub_problem.value}'. if yes press 1, else press 0 "
        )
    ...
    print(" ")
    print(
        "hurrey now you have build the config, you can actually check them in the configuration folder, feel free to check it out"
    )
    print("")
    print(
        "**********************************************************************************************"
    ...
    print(" ")
    print(
        "Thank you for the answering the questions now you can start working as per instructions"
    )
    print(
        "********************************************. END  .*********************************************"
    )
